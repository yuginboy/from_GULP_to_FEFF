...
class Struct:
    ...
    def fit_PM(self):
        ...
        B = self.xx[indx]
        M = self.yy[indx]
        self.forFit_x = (g_e*self.J*mu_Bohr*B)/k_b/self.T
        self.forFit_y = M
        ...
        self.yy_fit = func((g_e*self.J*mu_Bohr*self.xx)/k_b/self.T, n)
...
class ConcentrationOfMagneticIons:
    ...
    def subtract_Line(self):
        # try to subtract BG line: y=kx+b, which maybe correspond with a anisotropy effect
